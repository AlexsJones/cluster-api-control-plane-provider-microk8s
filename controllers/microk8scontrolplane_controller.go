...
//+kubebuilder:rbac:groups=cluster.cluster.x-k8s.io,resources=microk8scontrolplanes,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cluster.cluster.x-k8s.io,resources=microk8scontrolplanes/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cluster.cluster.x-k8s.io,resources=microk8scontrolplanes/finalizers,verbs=update
